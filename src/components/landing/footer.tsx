...
const socials: { label: string; href: string; icon: React.ReactNode }[] = [
  {
    label: "X / Twitter",
    href: "https://x.com/steamwriterai",
    icon: (
  ...
  {
    label: "Facebook",
    href: "https://facebook.com/steamwriterai",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-4">
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/steamwriterai",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-4">
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/@steamwriterai",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-4">
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/steamwriterai",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-4">
  ...
  {
    label: "Email",
    href: "mailto:hello@steamwriterai.com",
      ...
      <div className="border-border/60 border-t">
            ...
            <div className="mt-4 flex gap-2">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="border-border text-muted-foreground hover:text-foreground hover:border-primary flex size-9 items-center justify-center rounded-lg border bg-card transition-colors"
                >
                  {s.icon}
                </a>
              ))}
        ...
        <div className="border-border/60 border-t">
          <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-4 py-5 text-xs text-muted-foreground sm:flex-row sm:px-6 lg:px-8">
            <span>&copy; {new Date().getFullYear()} SteamWriterAi. All rights reserved.</span>
